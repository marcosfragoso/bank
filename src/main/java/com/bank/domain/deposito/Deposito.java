package com.bank.domain.deposito;
...
/**
 * Representação de um deposito de um banco contendo as seguintes informações: id, usuário que o valor vai ser depositado, valor do depósito e a data.
 * A anotation @Entity é utilizada para marcar a classe Deposito como uma entidade JPA representando uma tabela no banco de dados.
...
public class Deposito {
    ...
    /**
     * O usuário para quem está efetuando o depósito.
     * Anotation @ManyToOne referente ao relacionamento de Depósito com Usuario. Relacionamento muitos para um, ou seja, um usuário pode receber vários depósitos e um depósito apenas um usuário.
